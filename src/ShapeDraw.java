...
public class ShapeDraw extends JPanel {
     ...
     * to ass shapes to the drawing area and a menu that is used to select
    ...
    public ShapeDraw() {  
        ...
        sizeChoice = new JComboBox<String>();  // size choice menu
        sizeChoice.addItem("x1");
        sizeChoice.addItem("x2");
        sizeChoice.addItem("x3");
        sizeChoice.addItem("x4");
        sizeChoice.addActionListener(canvas);
    ...
    JComboBox<String> sizeChoice; // The size selection menu
    ...
    class DrawingArea extends JPanel
        ...
        Size currentSize;// current size; when a shape is created, this is its size
        Size x1,x2,x3,x4;
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (evt.getSource() == sizeChoice) {
                switch ( sizeChoice.getSelectedIndex() ) {
                case 0: currentSize = x1; break;
                case 1: currentSize = x2; break;
                case 2: currentSize = x3; break;
                case 3: currentSize = x4; break;
                }
            }
        }
        ...
        void addShape(Shape shape) {
            ...
            if(sizeChoice.getSelectedIndex()==1){
                shape.reshape(3,3,120,90);
            }
            if(sizeChoice.getSelectedIndex()==2){
                shape.reshape(3,3,160,130);
            }
            if(sizeChoice.getSelectedIndex()==3){
                shape.reshape(3,3,200,170);
            }
        }
